"""
Django settings for app_38544 project.
...
WSGI_APPLICATION = 'app_38544.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_38544 API",
    "DESCRIPTION": "API documentation for app_38544 App",
    "VERSION": "v1",
}
